...
@Configuration
@ConditionalOnClass({Resource.class, RestTemplateBuilder.class}) //конфигурация будет выполняться только при наличии классов Resource.class и RestTemplateBuilder.class по пути к классам
