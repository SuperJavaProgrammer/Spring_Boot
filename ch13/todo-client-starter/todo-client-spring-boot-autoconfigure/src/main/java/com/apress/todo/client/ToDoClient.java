...
public class ToDoClient {
    ...
    public ToDoClient() { }
    public ToDoClient(RestTemplate restTemplate, ToDoClientProperties props) {
    ...
    public ToDo findById(String id){
        UriComponents uriComponents = UriComponentsBuilder.newInstance()
                .uri(URI.create(this.props.getHost())).pathSegment(this.props.getPath(), "/{id}").buildAndExpand(id);
        ResponseEntity<ToDo> response = this.restTemplate.exchange(
