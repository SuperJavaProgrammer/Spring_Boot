...
public class UserConfig {
    ...
    public DataSource userDataSource() {
        return (DataSource) userDataSourceProperties().initializeDataSourceBuilder().type(HikariDataSource.class).build();
    }
    ...
    public LocalContainerEntityManagerFactoryBean userEntityManager(JpaProperties userJpaProperties) {
        ...
        return builder.dataSource(userDataSource()).packages(User.class).persistenceUnit("userDs").build();
    }
